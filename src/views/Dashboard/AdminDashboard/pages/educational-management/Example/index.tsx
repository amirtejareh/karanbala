            ...
            <Box className={classes.fieldOfStudy}>
                ...
                {!sampleTestQuestionsBasedOnChapters.isLoading ? (
                    <TableKit
                        ...
                        rows={sampleTestQuestionsBasedOnChapters?.data?.map(
                            (item: any, index: any) => {
                                return {
                                    id: item._id,
                                    data: {
                                        ...
                                        action: (
                                            <>
                                                ...
                                                <IconButton>
                                                    <PrompModalKit
                                                        description={
                                                            "آیا از حذف نمونه سوالات امتحانی مورد نظر مطمئن  هستید؟"
                                                        }
                                                        onConfirm={() =>
                                                            handleDeleteSampleTestQuestions(
                                                                item._id,
                                                            )
                                                        }
                                                        approved={"بله"}
