...
import useCreateSampleExampleQuestions from "../../../../../../hooks/sample-example-questions/useCreateSampleExampleQuestions";
import useDeleteSampleExampleQuestions from "../../../../../../hooks/sample-example-questions/useDeleteSampleExampleQuestions";
import useUpdateSampleExampleQuestions from "../../../../../../hooks/sample-example-questions/useUpdateSampleExampleQuestions";
import useGetSampleExampleQuestionsBasedOnSubjects from "../../../../../../hooks/sample-example-questions/useGetSampleExampleQuestionsBasedOnSubjects";
...
const Practice = () => {
  ...
  const createSampleExampleQestions = useCreateSampleExampleQuestions();
  const deleteSampleExampleQestions = useDeleteSampleExampleQuestions();
  const updateSampleExampleQestions = useUpdateSampleExampleQuestions();
  ...
  const handleDeleteSubject = (id: string) => {
    deleteSampleExampleQestions.mutate(id, {
      onSuccess: async (result: { message: string; statusCode: number; access_token: string }) => {
        if (result.statusCode == 200) {
          setLoading(false);
          sampleExampleQuestionsBasedOnSubjects.refetch();
  ...
  const sampleExampleQuestionsBasedOnSubjects = useGetSampleExampleQuestionsBasedOnSubjects(
  ...
  useEffect(() => {
    if (subjectIds) sampleExampleQuestionsBasedOnSubjects.refetch();
  }, [subjectIds]);
  ...
  const handleCreateSubject = async (data: any) => {
    createSampleExampleQestions.mutate(
  ...
  return (
    <Box className={classes.container}>
      ...
      <Box className={classes.fieldOfStudy}>
        <Typography>لیست تمارین داخل کتاب</Typography>
        {!sampleExampleQuestionsBasedOnSubjects.isLoading ? (
          <TableKit
            secondary
            headers={[{ children: `عنوان` }, { children: `عملیات` }]}
            rows={sampleExampleQuestionsBasedOnSubjects?.data?.map((item: any, index: any) => {
              return {
                id: item._id,
                data: {
