    ...
    <>
      ...
      <Box margin={"0.75rem 3.25rem 6rem 3.25rem"} paddingBottom={"7.5rem"}>
        ...
        >
          ...
          <Box display={"flex"} flexDirection={"column"} alignItems={"center"} marginTop={"4rem"}>
            <Box display={"flex"} gap={"0.8rem"}>
              ...
              <ButtonKit sx={{ padding: 0, minWidth: 0 }} onClick={() => navigate("/shop")}>
                <Box
                  bgcolor={theme?.palette?.grey["50"]}
                  padding={"1rem"}
                  borderRadius={".5rem"}
          ...
          >
            ...
            <Box flexBasis={"60%"} textAlign={"right"}>
              <img
                ...
                src={`${process.env.REACT_APP_BASE_URL}/${getGradeLevelBasedOnId?.data?.image}`}
                alt="dr samieee"
                width={"273rem"}
                height={"271rem"}
              />
        ...
        >
          ...
          >
            ...
            <Box marginTop={"1rem"} display={"flex"} justifyContent={"space-between"}>
              ...
              <Box>
                <ButtonKit variant="contained" onClick={() => navigate("/education-details")}>
                  شروع
                </ButtonKit>
              </Box>
            </Box>
        ...
        <Box
          ...
          gap={"10rem"}
        >
          <Box display={"flex"} flexDirection={"column"} alignItems={"center"} width={"28rem"}>
            <Box
              width={"20rem"}
              height={"20rem"}
              component={"img"}
