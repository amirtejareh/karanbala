...
export class SecondQuestionService {
   ...
   * @throws ApiError
   */
  public static secondQuestionControllerFindOne(id: string): CancelablePromise<any> {
    return __request(OpenAPI, {
      method: "GET",
   ...
   * @throws ApiError
   */
  public static secondQuestionControllerRemove(id: string): CancelablePromise<any> {
    return __request(OpenAPI, {
      method: "DELETE",
      url: "/second-question/{id}",
      path: {
