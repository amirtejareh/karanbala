...
export class SampleTestQuestionsService {
   ...
   * @throws ApiError
   */
  public static sampleTestQuestionsControllerFindOne(id: string): CancelablePromise<any> {
    return __request(OpenAPI, {
      method: "GET",
   ...
   * @throws ApiError
   */
  public static sampleTestQuestionsControllerRemove(id: string): CancelablePromise<any> {
    return __request(OpenAPI, {
      method: "DELETE",
      url: "/sample-test-questions/{id}",
      path: {
